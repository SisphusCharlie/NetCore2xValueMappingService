...
namespace ValueMappingCoreAPI.MiddleWare.BasicMiddleWare
{

    public class BasicUserMiddleWare
    {
        ...
        public BasicUserMiddleWare(RequestDelegate next, BasicUser user)
        {
            _next = next;
            _user = user;
        }
    ...
    public static class BasicMiddlewareExtensions
    {
        public static IApplicationBuilder UseBasicMiddleware(this IApplicationBuilder builder, BasicUser user)
        {
            ...
            return builder.UseMiddleware<BasicUserMiddleWare>(user);
        }
    }
}
